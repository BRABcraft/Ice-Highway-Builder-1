...
//                    }
                    ...
                    mc.interactionManager.clickSlot(syncId, handlerSlot, 0, SlotActionType.QUICK_MOVE, mc.player);
                    return true;
                }
            }
            state = returnToState;
...
//            }
    ...
    private void handleFlyToBlueIce() {
        ...
        //Every second, scan for blue ice.
        if (isInFrozenOcean && tick % 20 == 15) {
            scanningWorld = true;
        }
